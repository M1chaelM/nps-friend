...
alphabet $\Sigma = \{a\}$ that have $aa$ as  first characters.  Give a Post system for $K$.
...
\begin{parts}
\part[2] Prove that $b^{10}$ (i.e., $bbbbbbbbbb$) is in $P$. (Hint: a derivation is sufficient).
\vspace{30mm}
