...
\question
Consider the following formula: $A= q \land (p \lor \land p)$.
...
\question
Let $A$ be the formula $(p \implies \lnot q) \implies  \lnot (q \implies p)$
\begin{parts}
...
\question[2]
Let $U$ be a set of formulas, and let $U \vDash A$ for some formula $A$, and let $B$ be a valid formula.\\
What can you say about $U -\{B\}$?
