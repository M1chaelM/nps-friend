...
%\begin{wideslide}[bm=,toc=]{Computational complexity primer}
%\begin{itemize}
%\item Computational complexity is about the study of lower and upper bounds on {\em problems\/}.
%\item We need a problem whose complexity we can investigate.
%\item We pick {\em satisfiability\/} and {\em validity\/} in propositional logic.
%\item We will give lower bounds and decision procedures for each.
%\end{itemize}
%\end{wideslide}
