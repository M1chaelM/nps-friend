...
{\bf Facts:}\\
\begin{itemize}
\item<4-> Any valid formula of propositional logic is a valid formula of PTL.
\begin{itemize}
\item<5-> Ex: $(A \imp B) \imp A$ is a valid formula in both PL and PTL.
\end{itemize}
\item<6-> Any \emph{substitution instance} of a valid PL formula is valid.
\begin{itemize}
\item<7-> Ex: $(\Box p \imp \Box q) \imp \Box p$ is a substitution instance of a
